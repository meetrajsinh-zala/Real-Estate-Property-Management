...
if(isset($_POST['post'])){
   ...
   $property_name = htmlspecialchars($property_name, ENT_QUOTES);
   $price = $_POST['price'];
   $price = htmlspecialchars($price, ENT_QUOTES);
   $deposite = $_POST['deposite'];
   $deposite = htmlspecialchars($deposite, ENT_QUOTES);
   $address = $_POST['address'];
   $address = htmlspecialchars($address, ENT_QUOTES);
   $offer = $_POST['offer'];
   $offer = htmlspecialchars($offer, ENT_QUOTES);
   $type = $_POST['type'];
   $type = htmlspecialchars($type, ENT_QUOTES);
   $status = $_POST['status'];
   $status = htmlspecialchars($status, ENT_QUOTES);
   $furnished = $_POST['furnished'];
   $furnished = htmlspecialchars($furnished, ENT_QUOTES);
   $bhk = $_POST['bhk'];
   $bhk = htmlspecialchars($bhk, ENT_QUOTES);
   $loan = $_POST['loan'];
   $loan = htmlspecialchars($loan, ENT_QUOTES);
   ...
   $image_04 = htmlspecialchars($image_04, ENT_QUOTES);
   ...
   $image_05 = htmlspecialchars($image_05, ENT_QUOTES);
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property = $conn->prepare("INSERT INTO `property`(id, user_id, property_name, address, price, type, offer, status, furnished, bhk, deposite, loan, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
      $insert_property->execute([$id, $user_id, $property_name, $address, $price, $type, $offer, $status, $furnished, $bhk, $deposite,$loan, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
