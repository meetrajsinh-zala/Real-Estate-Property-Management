...
if(isset($_POST['h_search'])){
   ...
   $h_location = htmlspecialchars($h_location, ENT_QUOTES);
   $h_type = $_POST['h_type'];
   $h_type = htmlspecialchars($h_type, ENT_QUOTES);
   $h_offer = $_POST['h_offer'];
   $h_offer = htmlspecialchars($h_offer, ENT_QUOTES);
   $h_min = $_POST['h_min'];
   $h_min = htmlspecialchars($h_min, ENT_QUOTES);
   $h_max = $_POST['h_max'];
   $h_max = htmlspecialchars($h_max, ENT_QUOTES);
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            ...
            <div class="flex-btn">
               ...
               <?php
               if(isset($fetch_property['user_id']) != isset($_COOKIE['user_id']))
               {
